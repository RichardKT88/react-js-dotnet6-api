...
export default function NewBook() {
    ...
    //Serve para trazer os dados enquanto carrega a página.
    useEffect(() => {
        if (bookId === '0') return;
        else loadBook();
    }, bookId);
    ...
    async function loadBook() {
        try {
            ...
            //O split divide no T de (2009-01-10T00:00:00) cria um Array com duas posições. A posição 0 = 2009-01-10, a posição 1 = 00:00:00.
